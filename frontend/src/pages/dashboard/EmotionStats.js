        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ height: "100%" }}>
            <CardContent sx={{ textAlign: "center" }}>
              ...
              <Typography
                variant="h3"
                sx={{ fontWeight: 700, color: moodInfo.color }}
              >
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ height: "100%" }}>
            <CardContent sx={{ textAlign: "center" }}>
              ...
              <Typography
                variant="h2"
                sx={{ fontWeight: 700, color: "#ff9800", my: 2 }}
              >
                {stats?.streak || 0}
              </Typography>
